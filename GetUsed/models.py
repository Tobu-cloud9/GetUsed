...
class Search(models.Model):
    ...
    username = models.CharField(verbose_name='username', max_length=40, default="", null=True)
    keyword = models.CharField(verbose_name='keyword', max_length=40, default="", null=True)
    max_price = models.PositiveIntegerField(verbose_name='max_price', default=10000, null=True)
    min_price = models.PositiveIntegerField(verbose_name='min_price', default=0, null=True)
...
class Item(models.Model):
    ...
    item_search = models.ForeignKey(Search, verbose_name='search', related_name='item_search', on_delete=models.CASCADE)
    item_type = models.CharField(verbose_name='shop', max_length=1, choices=ItemType, null=True, default='')
